...
public class IceFishingSpeakCommand implements EventCommand {
    ...
    public IceFishingSpeakCommand(String npcId, String mode, String text, String playerText, String npcText) {
    ...
    public void start(EventPlayer player) {
        ...
        String displayText = switch (mode) {
            case MODE_WINNER -> IceFishingCutsceneClientState.winnerText();
            case MODE_BRANCH -> IceFishingCutsceneClientState.playerWon() ? playerText : npcText;
            default -> text;
        };
