...
public final class SecretNoteStoryFlags {
    ...
    public static final String QI_CAVE_TEMP_REWARD_GRANTED = "secretNote10_temp_reward_granted";
    public static final String IRIDIUM_MILK_CONSUMED = "stardewcraft.iridium_milk_consumed";

    private SecretNoteStoryFlags() {
    }
}
