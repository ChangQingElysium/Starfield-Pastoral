 ...
 * 甜菜作物
 */
public class BeetCropBlock extends StardewCropBlock {

    private static final int[] PHASE_DAYS = new int[]{1, 1, 2, 2};

    @SuppressWarnings("null")
    public BeetCropBlock() {
        super(Properties.of()
    ...
    protected Supplier<Item> getSeedsItem() {
        return ModItems.BEET_SEEDS;
    }

    @Override
    protected Supplier<Item> getCropItem() {
        return ModItems.BEET;
    }
    ...
    protected ItemStack getHarvestItem(int quality) {
        @SuppressWarnings("null")
        ItemStack stack = new ItemStack(ModItems.BEET.get());
