 ...
 * 萝卜作物
 */
public class RadishCropBlock extends StardewCropBlock {

    private static final int[] PHASE_DAYS = new int[]{2, 1, 2, 1};
    ...
    protected ItemStack getHarvestItem(int quality) {
        @SuppressWarnings("null")
        ItemStack stack = new ItemStack(ModItems.RADISH.get());
