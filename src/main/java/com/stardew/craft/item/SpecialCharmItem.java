...
/** Permanent special item awarded by the secret-note-20 truck driver. */
public final class SpecialCharmItem extends Item implements IStardewItem {
    private static final int NAME_BASE_RGB = 0x9A55C7;
    private static final int NAME_HIGHLIGHT_RGB = 0xFFE7A8;
    private static final float SWEEP_SPEED = 0.40F;
    private static final float SWEEP_WIDTH = 0.30F;

    public SpecialCharmItem(Properties properties) {
        super(properties);
    }
    ...
    public void inventoryTick(@Nonnull ItemStack stack, @Nonnull Level level, @Nonnull Entity entity,
        ...
        SecretNote20Service.grantSpecialCharm(player, PlayerDataManager.getPlayerData(player));
    }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull TooltipContext context,
        ...
        tooltipComponents.add(Component.translatable("stardewcraft.item.special_charm.tooltip.flavor")
                .withStyle(Style.EMPTY.withColor(TextColor.fromRgb(0xB879DD))));
        tooltipComponents.add(Component.translatable("stardewcraft.item.special_charm.tooltip.granted")
                .withStyle(Style.EMPTY.withColor(TextColor.fromRgb(0xFFE099)).withBold(true)));
    }
