...
/**
 * Server-authoritative lifecycle for Infinity Dagger's original Singularity Stab.
 */
public final class InfinityDaggerSingularityStabSkillHandler
    ...
    public void begin(SkillExecutionContext context, SkillInstance instance) {
        ...
        if (target == null) {
            throw new IllegalStateException(
                    "Singularity Stab target disappeared after validation"
            );
        }
