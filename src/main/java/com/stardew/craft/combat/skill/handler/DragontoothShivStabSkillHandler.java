...
/**
 * Server-authoritative extraction of Dragontooth Shiv's original stab.
 */
public final class DragontoothShivStabSkillHandler
    ...
    public void begin(SkillExecutionContext context, SkillInstance instance) {
        ...
        if (target == null) {
            throw new IllegalStateException(
                    "Validated Dragontooth Shiv target is unavailable"
            );
        }
