...
/**
 * Server-authoritative extraction of Rusty Sword's original Tetanus Strike.
 */
public final class TetanusStrikeSkillHandler implements RuntimeWeaponSkillHandler {
    public static final double TARGET_RANGE = 4.0;
    public static final int VULNERABLE_DURATION_TICKS = 60;
    public static final int VULNERABLE_AMPLIFIER = 0;
