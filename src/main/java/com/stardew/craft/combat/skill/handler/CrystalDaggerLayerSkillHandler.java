...
/**
 * Server-authoritative extraction of Crystal Dagger's original Crystal Layer.
 */
public final class CrystalDaggerLayerSkillHandler implements RuntimeWeaponSkillHandler {
    public static final double TARGET_RANGE = 4.0;
    public static final double NO_TARGET_DASH_DISTANCE = 3.0;
    ...
    public void begin(SkillExecutionContext context, SkillInstance instance) {
        ...
        // Authored behavior: even an empty dash grants and refreshes one layer.
